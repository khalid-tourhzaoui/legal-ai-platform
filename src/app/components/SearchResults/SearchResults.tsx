...
export default function SearchResults({
  ...
  const HeaderBar = ({ title, icon, rightContent }: HeaderBarProps) => (
                  ...
                  <div className="relative z-10 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-700 text-sm sm:text-base font-medium leading-relaxed">
                        ...
                        رسمية. ينصح بالتشاور مع محامٍ مختص للحصول على مشورة
                        قانونية دقيقة تناسب حالتك الخاصة.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  {copied ? (
                    ...
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2.5}
                      d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-3 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"
                    />
                  )}
                </svg>
